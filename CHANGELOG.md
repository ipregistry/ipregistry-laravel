...
- Route middleware: `ipregistry` (enrichment with per-route field selection), `ipregistry.countries` (block/allow by country), `ipregistry.threats` (threat and anonymization blocking).
